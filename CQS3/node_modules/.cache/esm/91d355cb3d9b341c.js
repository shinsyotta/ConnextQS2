let ConnextClientStorePrefix;_3d9‍.x([["default",()=>Store]]);_3d9‍.w("@connext/types",[["ConnextClientStorePrefix",["ConnextClientStorePrefix"],function(v){ConnextClientStorePrefix=v}]]);
const fs = require("fs")
      ...
      if (
        ...
        try {
          ...
          if (e.message && e.message.match(/Appointment already exists and nonce too low./)) {
            _3d9‍.g.console.warn(e);
          } else {
            _3d9‍.g.console.error(e);
          }
        }
      }
    }
