...
import { AppActionBigNumber, AppRegistry, AppState, DefaultApp, SupportedApplication, SupportedNetwork } from "./app";
...
import { ChannelProvider, ChannelProviderConfig, ChannelProviderRpcMethod, KeyGen, StorePair } from "./channelProvider";
import { CheckDepositRightsParameters, CheckDepositRightsResponse, ConditionalTransferParameters, ConditionalTransferResponse, DepositParameters, RequestDepositRightsParameters, RescindDepositRightsParameters, RescindDepositRightsResponse, ResolveConditionParameters, ResolveConditionResponse, ResolveLinkedTransferResponse, SwapParameters, TransferParameters, WithdrawParameters } from "./inputs";
import { CreateChannelResponse, GetChannelResponse, GetConfigResponse, RequestCollateralResponse, Transfer } from "./node";
...
export interface IConnextClient {
    ...
    requestDepositRights(params: RequestDepositRightsParameters): Promise<CFCoreTypes.RequestDepositRightsResult>;
    ...
    reclaimPendingAsyncTransfer(amount: string, assetId: string, paymentId: string, encryptedPreImage: string): Promise<ResolveLinkedTransferResponse>;
    ...
    getProposedAppInstances(multisigAddress?: string): Promise<CFCoreTypes.GetProposedAppInstancesResult | undefined>;
    getProposedAppInstance(appInstanceId: string): Promise<CFCoreTypes.GetProposedAppInstanceResult | undefined>;
    ...
    takeAction(appInstanceId: string, action: AppActionBigNumber): Promise<CFCoreTypes.TakeActionResult>;
    updateState(appInstanceId: string, newState: AppState | any): Promise<CFCoreTypes.UpdateStateResult>;
