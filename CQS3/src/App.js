...
// });
// channel.on("UPDATE_STATE_EVENT", (data) => {
//   console.log(`BING BING! State has been updated: ${JSON.stringify(data, null, 2)}`)
//   // const state = await channel.getAppInstanceDetails()
//   // console.log(``)
// });
// channel.on("")
channel.on("RECIEVE_TRANSFER_STARTED_EVENT", () => {
  console.log("Started to receive transfer with incorrect spelling");
  // console.log(`Here is the info: ${JSON.stringify(data, null, 2)}`)
  // const
  // this.showRecieveTransferStarted()
});
channel.on("RECIEVE_TRANSFER_FINISHED_EVENT", () => {
  console.log("Finished receiving transfer with incorrect spelling");
  // console.log(`Here is the info: ${JSON.stringify(data, null, 2)}`)
  // const
  // this.showRecieveTransferStarted()
});
...
//   this.showReceiveTransferStarted()
// });
...
// const txpayload = {
//   recipient: "xpub6EFEdKFkzUk4YQ6TvCdpWaSc3duUkV8xcUSfKabyExGZtbSsNZo7KZ2FuHBkqtknm89Ue7F4wVv8ysmedvkRzfjvTidD4JnzPxCkFASdRmL",  // <-- Laptop  //counterparty's xPub // Desktop: xpub6E4pdmd9dV7vWMExS4ComHiPj7STndSmyWJWyn4G2U8sDGcxwp4V6TDkS2WScCCMtUtfFSaND69HySuZag25PG7K7PoYYVxABWtm5tZip2f
//   meta: "Metadata for transfer", // any string value, or omit
//   amount: parseEther("0.1").toString(), // in wei (ethers.js methods are very convenient for getting wei amounts)
//   assetId: AddressZero // ETH
// }
// //
// await channel.transfer(txpayload)
...
// });
  // console.log("Starting my freestyle now...");
  // console.log(await store.getAppInstanceDetails());
